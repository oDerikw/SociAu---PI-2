...
<div class="quiz_section_yellow">
   <div class="quiz">
      <div class="button-grp-diff" id="categoria2">
         <a href="{{ route('play', ['category' => 'cotidiano', 'difficulty' => 'facil']) }}" id="btn1">Fácil</a>
         <a href="{{ route('play', ['category' => 'cotidiano', 'difficulty' => 'medio']) }}" id="btn2">Médio</a>
         <a href="{{ route('play', ['category' => 'cotidiano', 'difficulty' => 'dificil']) }}" id="btn3">Difícil</a>
      </div>
      <div class="diff-gif">
